...
<template>
    <div class="relative">
        ...
        <USlideover v-model:open="isOpen" side="right" :ui="{ content: 'max-w-md' }" class='bg-white'>
            <template #header>
            ...
            <template #body>
                ...
                <div v-else class="flex flex-col gap-4">
                    <div v-for="item in cartStore.items" :key="item.id"
                        ...
                        <ImageImg :src="item.image" :alt="item.name" class="w-20 h-24 object-contain rounded-md" />
                        ...
                        <div class="flex-1 flex flex-col justify-between">
                            ...
                            <div class="flex items-center justify-between mt-2">
                                <div class="flex items-center justify-between gap-2">
                                    ...
                                    <span
                                        class="inline-flex items-center justify-center w-12 h-8 text-sm font-medium border rounded-md">
                                        {{ item.quantity }}
                                    </span>
